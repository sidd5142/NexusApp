package com.example.nexusapp.User
    ...
    Column(
        ...
        Card(
            ...
            Column(
                ...
                Spacer(modifier = Modifier.height(8.dp))
                Text(text = "College: KIET GROUP OF ISNTITUTION", fontSize = 18.sp, fontWeight = FontWeight.Medium)
                Spacer(modifier = Modifier.height(8.dp))
                Text(text = "Year of Graduation: 2026", fontSize = 18.sp, fontWeight = FontWeight.Medium)
            }
        }
        ...
        Card(
            ...
            Column(
                ...
                OutlinedTextField(
                    ...
                    label = { Text("Looking for Job/Internship") },
                    singleLine = true,
                    modifier = Modifier.fillMaxWidth()
                )
                Spacer(modifier = Modifier.height(8.dp))
                OutlinedTextField(
                    ...
                    label = { Text("Upload your resume (add a statement for consideration)") },
                    singleLine = true,
                    modifier = Modifier.fillMaxWidth()
                )
            }
